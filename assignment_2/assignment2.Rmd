...
The error correction coefficient $\gamma$ = `r bestmodel$coefficients[1]` and it is not statisctically significant from zero, meaning there is not a correction towards the equilibrium value.
...
The error correction coefficient $\gamma$ = `r bestmodel$coefficients[1]` is not different from zero. Hence, there is no overshooting $\gamma < -1$. 
