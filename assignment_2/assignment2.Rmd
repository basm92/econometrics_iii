...
longformula <- paste("fdy ~ ztm1 +", paste(indep_vars, collapse = " + "))
# run the stepwise regression - find the best model
null = lm(data = data_ecm, formula = "fdy ~ ztm1")
...
Report and interpret the short-run andlong-run multipliers.  Report and interpret the error correction coefficient.

Lecture 4, slide 78 and onward: error correction model interpretation
6.  How strong is the correction to equilibrium?  Is there over-shooting?  Do you find evidence of Granger causality?  Justify your answer.