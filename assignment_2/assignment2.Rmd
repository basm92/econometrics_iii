...
The error correction coefficient $\gamma$ = `r bestmodel$coefficients[1]` and it is statistically significant from zero, meaning there is a (relatively small) correction towards the equilibrium value.
